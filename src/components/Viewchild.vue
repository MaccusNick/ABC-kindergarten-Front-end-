<template>
  <div class="cpic">
    ...
    style="width: 70%">
    <template slot="empty">
      Ready to view the valuable data?
    ...
    <el-table-column
      prop="CildStatus"
      label="ChildStatus" :formatter="formatBoolean">
    </el-table-column>
    ...
    <div>
      ...
      <el-button type="primary" @click="showparent" class="login_style">Display Child Report</el-button>
    </div>
